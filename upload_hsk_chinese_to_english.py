#!/usr/bin/env python3
"""
Upload HSK Chinese to English Decks

Uploads HSK 1-5 decks as Chinese to English with proper naming and pronunciation.
"""
...
def upload_hsk_deck(hsk_level: int, supabase: Client):
    ...
    print(f"\n🚀 Uploading HSK Level {hsk_level} (Chinese to English)")
    print("=" * 60)
    
    # File paths
    input_file = f"hsk_api_enhanced_vocabulary/hsk{hsk_level}_api_enhanced.csv"
    deck_name = f"HSK Level {hsk_level} Chinese to English"
...
def main():
    ...
    print("🎯 Uploading HSK 1-5 Decks (Chinese to English) to Supabase")
    print("=" * 70)
    ...
    if success_count == 5:
        print("🎊 All HSK Chinese to English decks uploaded successfully!")
        print("🔊 Pronunciation configured: Chinese (zh-CN) to English (en-US)")
    else:
