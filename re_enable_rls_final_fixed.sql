-y Re-enable RLS for French LexiqueData mapping tables with proper policies
...
DROP POLICY IF EXISTS french_lexique_words_all_access ON french_lexique_words;
...
DROP POLICY IF EXISTS french_vocab_lexique_mapping_all_access ON french_vocabulary_lexique_mapping;
